  ...
  <body class="bg-blue-50">
    <div class="m-4">
      <div class="credit-card w-full sm:w-auto shadow-lg mx-auto rounded-xl bg-white" x-data="creditCard">
          ...
          >
            ...
            <div class="front bg-transparent text-lg w-full text-white px-12 absolute left-0 bottom-12">
              ...
              <div class="flex flex-row justify-between">
                <p x-text="cardholder !== '' ? cardholder : 'Nama Anda'"></p>
                <div class="">
          ...
          >
            ...
            >
              <div class="border border-white w-16 h-9 flex justify-center items-center">
                <p x-text="securityCode !== '' ? securityCode : 'Kode Keamanan'"></p>
              </div>
            </div>
          </div>
          <ul class="flex">
        ...
        <main class="mt-4 p-4">
          <h1 class="text-xl font-semibold text-gray-700 text-center">ATM Mandala Bank</h1>
          <div class="">
            <div class="my-3">
              <input
                type="text"
    ...
    <script>
      document.addEventListener("alpine:init", () => {
        Alpine.data("creditCard", () => ({
          ...
          onSubmit() {
            alert(`Selamat datang ${this.cardholder}.`);
          },
          cardholder: '',
          cardNumber: '',
          expired: {
